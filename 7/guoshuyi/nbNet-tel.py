...
#            else:
#                return "readmore"
            end = sock_state.buff_read.find("\\r\\n")
            print sock_state.buff_read
            print end
            if end == -1:
                return "readmore"
            else:
                sock_state.buff_read = sock_state.buff_read[0:end]
                return "process"
...
class nbNet(nbNetBase):
    ...
    def process(self, fd):
        ...
        sock_state.buff_write = response
    ...
    def read2process(self, fd):
        ...
        if read_ret == "process":
            ...
            raise Exception("imposible state rerurned by self.read")
...
if __name__ == '__main__':
    ...
    reverseD = nbNet('0.0.0.0', 40000, logic)
    reverseD.run()
