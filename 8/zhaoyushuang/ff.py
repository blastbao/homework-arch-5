...
# alarmItems = { mon_key :[alarm_times,n] }

def ff(input):
    #load monitor data
    mon_data=json.load(input)

    #this line is for testmonitor to test
    #mon_data=input
...
def testMonitor():
    ...
    {"MemTotal": 15888, "MemUsage": 1004, "MemFree": 14083, "Host": "teach.works", "LoadAvg": 0.15, "Time": 1434246835},
